...
.title      : test base 64 ascii codec
.kind       : c source
...
This program tests the base 64 ascii encoder and decoder functions. 
...
int main() {
	...
	* DATA_SIZE_MIN - DATA_SIZE_MAX */
       ...
       b64encode(random_data,random_data_size,encoded_data);
       error = b64decode(encoded_data,decoded_data,&decoded_data_size);
